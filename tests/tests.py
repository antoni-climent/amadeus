...
if __name__ == "__main__":
    ...
    model_id, output_dir = "google/gemma-3-4b-it", "../gemma3-4b-dapt-kurisu_v2"
    ...
    user_inputs = ["Hi Christina!", "What do you think about time travel?", "Who are you? Tell me all you know about yourself.", \
                "Have you figured out time travel already?", "What is the phonewave?", "What is your opinion about me?", \
                    "Do you know Daru?", "What is your favourite song?"]
    ...
    with open(csv_name, 'w') as file:
        ...
        for user_input in user_inputs:
            ...
            writer.writerow([user_input, generated_text])
            file.flush()
            print("Completed: ", user_input)

        writer.writerow(["", ""])
        writer.writerow(["Initial message:", str(initial_message)])
        writer.writerow(["Model used:", output_dir])